...
# d = {p1:c1, p2:c2}
# print(make_pets(d))  # prints ana:furball
       #        james:fluffsphere
...
class Employee(Person):
    ...
    def salary_change(self, n):
        ...
        if self.salary < 0:
            self.salary = 0
        self.sal_hist.append(self.salary)
