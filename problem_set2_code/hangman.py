...
def hangman(secret_word, with_help):
    ...
    * User to supply one guess per round. The user puts in a single letter 
      (or help character '!' for with_help functionality)
    ...
    * After each guess, display the partially guessed word so far.

    -----------------------------------
    with_help functionality
    -----------------------------------
    * If the guess is the symbol !, reveal to the user one of the
      letters missing from the word at the cost of 3 guesses. If the user does
      not have 3 guesses remaining, display a warning message. Otherwise, add
