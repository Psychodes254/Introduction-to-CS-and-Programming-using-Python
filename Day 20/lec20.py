...
w_two = Workout('1/1/2021 3:30 PM', '1/1/2021 4:00 PM', 300)
...
# # what is the calories val through get_calories() = 100 calories
# # what is the elevation val through get_elev() = Error
# print(w1.get_calories())
# print(w1.get_elev())

w2 = Workout('9/30/2021 2:20 PM','9/30/2021 2:50 PM', 450)  
# # what is the calories val through get_calories() = 450
# # what is the elevation val through get_elev() = Error
# print(w2.get_calories())
# print(w2.get_elev())

rw1 = RunWorkout('9/30/2021 2:20 PM','9/30/2021 2:50 PM', 250) 
# # what is the calories val through get_calories() = 100
# # what is the elevation val through get_elev() = 250
# print(rw1.get_calories())
# print(rw1.get_elev())

rw2 = RunWorkout('9/30/2021 2:20 PM','9/30/2021 2:50 PM', 450, 700) 
# # what is the calories val through get_calories() = 700
# # what is the elevation val through get_elev() = 450
# print(rw2.get_calories())
# print(rw2.get_elev())

rw3 = RunWorkout('9/30/2021 2:20 PM','9/30/2021 2:50 PM', calories=300) 
# # what is the calories val through get_calories() = 300
# # what is the elevation val through get_elev() = 0
...
def total_elapsed_time(L):
    ...
    for elem in L:
        time = Workout(elem[0], elem[1])
        total += time.get_duration().total_seconds()
